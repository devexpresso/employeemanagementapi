...
namespace WebApi.Framework.Controllers
{
    ...
    public class EmployeeController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> AddEmployee([System.Web.Mvc.Bind(Include = "EmployeeId,FirstName,LastName,DateOfBirth,Department,ProjectId,Billable")] Employee emp)
        {
            try
            {
        ...
        public async Task<HttpResponseMessage> UpdateEmployee([System.Web.Mvc.Bind(Include = "EmployeeId,FirstName,LastName,DateOfBirth,Department,ProjectId,Billable")] Employee emp)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    var result = await DocumentDBRepository<Employee>.UpdateItemAsync(emp.EmployeeId, emp);
